...
//
// var fruits = ["Banana", "Orange", "Apple", "Mango"];
// fruits.unshift("Lemon");    // Adds a new element "Lemon" to the first index of fruits
// console.log(fruits);
//
// var fruits = ["Banana", "Orange", "Apple", "Mango"];
...
// there is also splice (a,b,c)= 
// a= the index wich it will begiin deleting 
// b= the number of elements that it will delete
// c=(not mandatory) the elements you want to put instead of the deleted ones
//
